...
| Sl. No. | Event Name | Event Type | Event Date |
| :---: | :---: | :---: | :---: |
| **1\.** | Path Follower | Technical | 27th March |
| **2\.** | Lathe War | Technical | 28th March |
| **3\.** | Circuitronix | Technical | 28th March |
| **4\.** | Coding Premier League | Technical | 27th March |
| **5\.** | Re \- Fab  | Technical | 27th March |
| **6\.** | Treasure Hunt | Non \- Technical | 28th March |
| **7\.** | Dil Se Design | Technical | 28th March |
| **8\.** | Bridge Building | Technical | 27th March |
| **9\.** | Tower Making | Technical | 27th March |
| **10\.** | Dance Battle | Non \- Technical | 27th March |
| **11\.** | Valorant | E-Sports | 27th March |
| **12\.** | Arm Wrestling | Non \- Technical | 27th March |
| **13\.** | Power Deal | Business | 27th March |
| **14\.** | The Tech Monopoly | Business | 28th March |
| **15\.** | Rap Battle | Non \- Technical | 28th March |
| **16\.** | Robo Soccer | Technical | 28th March |
| **17\.** | BGMI | E-Sports | 28th March |
| **18\.** | E-Football | E-Sports | 28th March |
| **19\.** | Free Fire | E-Sports | 27th March |
...
4️Participation Details:

* Team Event  
* Team Size: 3 Members  
* Registration Fee: ₹219 per team  
* Expected Teams: Approximately 10  
* Open to inter-college participants

5️Event Format / Structure:
...
**Round 1: Theoretical Round (20 Marks)**

* 20 Multiple Choice Questions  
* Topics: Lathe machines, cutting tools, operations, tolerances, and safety  
* Each question carries 1 mark  
  **Round 2: Practical Machining Round (30 Marks)**  
* Teams will machine a component based on a given technical drawing  
* Raw material (specified dimensions) will be provided  
* Detailed drawing with dimensions and tolerance limits will be given  
* All machining must be completed within the allotted time  
* No extra time will be provided

**6️Judging Criteria:**

**Theoretical Round (20 Marks)**

* 1 mark per correct MCQ

**Practical Round (30 Marks)**

* Dimensional Accuracy – 20 Marks

* Surface Finish & Machining Quality – 10 Marks

**Disqualification Conditions:**

* Exceeding tolerance limits beyond acceptable range

* Unsafe working practices

* Intentional damage to machine or tools

* Using unauthorized tools

* Taking external assistance
...
* Objective-based and short-answer technical questions  
* Includes multiple-choice and multiple-select questions  
* Negative marking applicable  
* No internet access allowed

Round 2: Hardware & Software Integration

* Teams will build and program circuits using provided components  
* Internet access allowed  
* Includes project development and PPT preparation

Final Evaluation:

* Project presentation and judging based on implementation and performance
...
* Individual / Team Coding Event (Maximum 4\)  
* Registration Fee: ₹240  
* Open to inter-college participants  
* Certificates provided to participants

5️Event Format / Structure

Coding Challenge Round:

* Participants will solve multiple programming problems within a fixed time limit  
* Problems will vary in difficulty levels, testing logic, algorithms, and optimization skills  
* Scoring based on correctness, efficiency, and submission time

Final Ranking:

* Participants ranked based on total score and time efficiency
...
* In-kind Value: Certificates and Cheque awards for winners
...
* Team Event  
* Team Size: 4 Members  
* Expected Participation: 10 Teams (Approx. 40 Participants)  
* Registration Fee: ₹280  
* Open to inter-college participants

5️Event Format / Structure

Design & Fabrication Challenge:

* Teams will be given a problem statement or creative task  
* Participants must ideate, design, and develop a solution within the given time  
...
* Prize Pool: ₹10,000  
* In-kind Value: Certificates and Cheque awards
...
* Teams will receive sequential clues leading to different campus locations  
* Each clue must be solved to unlock the next stage  
* Tasks or mini-challenges may be included at checkpoints

Final Round:

* The team that successfully reaches the final location in the shortest time with correct solutions will be declared the winner
...
Design Challenge Round:

* Participants will be given a design theme or problem statement  
* Designs must be created within the allotted time  
* Participants will present their final designs for evaluation

Final Evaluation:

* Judging based on creativity, originality, and execution quality
...
* Registration Fee: ₹280 per team  
* Expected Teams: Approximately 10  
* Open to inter-college participants

5️Event Format / Structure:

* Each team will be provided with **150 ice cream sticks and glue**  
...
* Solo  / Crew Event  
* Team Size: 1 / 2 / 3 / 4 / 5 Members  
* Registration Fee: ₹199 (Solo) / ₹499 (Duo/Crew)  
* Open to inter-college participants

5️ Event Format / Structure:
...
* Theme-based performances permitted (no offensive or inappropriate content)  
* Props allowed (safe and setup within 30 seconds)  
* Participants responsible for costumes and makeup  
...
* Mode: Competitive 5v5 Standard  
* Win Condition: First to 13 rounds  
* Overtime: Win by 2 (if 12–12)  
* Match Setting: Tournament Mode (Custom Lobby)  
* Agents: All live agents allowed unless globally banned
...
**Best of 1 (Online Qualifiers & Semi-Finals):**
...
* Team B bans  
* Team A bans  
* Team B selects final map

**Best of 3 (Grand Finals):**

* Alternate bans and picks  
* Two maps selected  
* Remaining map becomes Decider

**Tournament Progression**

**Online Stage (Single Elimination):**

* Early Qualifiers – Bo1  
* Quarter-Finals – Bo1
...
6️Judging Criteria / Fair Play Regulations:
...
* Exceeding grace period results in Technical Forfeit

**Conduct & Sportsmanship**

* Zero tolerance for racism, sexism, or hate speech  
* Excessive toxicity subject to referee action

**Timeouts**

* Two Tactical Timeouts (60 seconds each) per team  
* Technical pauses only for genuine hardware/network failure  
* Abuse of technical pause leads to penalties

ANY violation may result in immediate disqualification and potential ban from future editions.
...
* Unintentional slip → Strap match applied  
* Intentional slip → Foul

**Foul System:**

* Two fouls may result in loss of the match  
* Dangerous arm positions may lead to immediate stoppage

Participants must report 30 minutes before their match.

6️Judging Criteria / Rules Enforcement:

**Common Fouls:**

* Elbow lifting off the pad  
* Early start before referee signal  
* Releasing side peg  
* Shoulder crossing center line  
* Intentional slip  
...
* Projector \+ Laptop  
* Excel/PowerPoint slide showing company name, starting bid, bid increment  
...
**Round 1 – Initial Investment Phase**

* Each team receives virtual capital (e.g., ₹10,00,000)  
* Mandatory diversification across startups  
* Teams build initial investment portfolio

**Round 2 – Market Update Phase**

* Structured market updates announced  
* Startup valuations rise/fall  
* Portfolio adjustment opportunity provided

**Round 3 – Crisis / Opportunity Phase**

* Simulated economic shift introduced  
* Final rebalancing of investments

**Final Round – Portfolio Valuation**

* Net worth calculated  
* Team with highest final portfolio value wins
...
* Solo / Duo / Group Event  
* Team Size: 1 / 2 / 3 / 4 Members  
* Registration Fee: ₹149 per participant/team  
* Open to inter-college participants
...
* Written and freestyle performances allowed (unless round specifies otherwise)

**Reporting & Time Management**

* Participants must report 30 minutes before event  
* Late arrival may result in elimination  
* Absence when called → opponent advances automatically
...
Judges’ decision will be final and binding.  
No arguments permitted on stage.

7️Rules & Code of Conduct:
...
* Defamation of real individuals within the college
...
* Light roasting  
* Creative punchlines  
* Competitive disses within respectful limits  
* Wordplay and metaphor-driven attacks

**Conduct Regulations**

* No physical contact with opponent  
* No pushing, touching, or invading personal space  
* No throwing objects  
* No alcohol or substance use before performance  
* Respect judges, host, and audience

Violation \= Immediate disqualification.

8️Technical & Safety Requirements:
...
Organizing committee reserves the right to stop any performance, modify format, or disqualify disruptive participants.
...
* 1Test robot design efficiency and maneuverability  
...
* 6-minute match (3 minutes per half)  
...
* 2-minute sudden death  
* 3 penalty shots per team  
* Sudden shootout if required

6️Judging Criteria (Total 100 Marks):
...
7️Technical Specifications & Requirements:

**Field Specifications**

* Rectangular field (6 ft × 4 ft)  
* Flat, smooth surface  
* Goal width: 30 cm  
* Goal depth: Minimum 10 cm  
* Clearly marked center line and circle

**Robot Specifications**

* Maximum size: 25 cm × 25 cm  
* No sharp edges or hazardous projections  
* No ball grabbing or trapping mechanisms  
* Intentional damage leads to penalty/disqualification

**Power System**

* External AC supply provided by organizers  
* Maximum operating voltage: 24V DC  
* Batteries allowed up to 24V DC  
* Robots must be compatible with provided supply  
* Unsafe current draw may result in disqualification

**Control System**

* Manual control only  
* Wireless (Bluetooth/WiFi – ESP based) allowed  
* Signal interference strictly prohibited

**Fouls & Penalties**

* Minor Foul: Blocking, pushing, trapping – Free hit  
...
* Team Event  
* Team Size: 4 Players (Starting Lineup)  
* Registration Fee: ₹399 per team  
* Open to eligible Indian students

**Eligibility Highlights (From Rulebook – Page 1):**

* Minimum age: 16 years  
* Minimum Rank: Platinum I  
* Minimum Level: 30  
* Indian Nationals only  
* Single Team Exclusivity enforced

5️Event Format / Structure:

**Match Parameters (Page 9\)**
...
* Highest cumulative placement points  
* Highest finishes across matches  
...
* Mode: Authentic Match-Up  
* Dream Team: Not Allowed  
* Custom Squads: Not Allowed

Match Settings

* Match Time: 6 Minutes  
* Extra Time: Enabled (Knockout)  
* Penalties: Enabled  
* Smart Assist: OFF (Mandatory)  
* Uniform Ratings Only

Team Selection Rules

* Teams from Top European Leagues only  
* Team locked after selection  
* Maximum 2 changes during tournament (with admin approval)

6️Fair Play Regulations:
...
6️Conduct & Compliance:

Strictly prohibited:

* Teaming  
* Bug exploitation  
* Hacks or third-party tools  
* Ringing  
* Vulgar speech  
* Streaming without permission
