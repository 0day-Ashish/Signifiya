...
export const eventDetails: Record<string, EventDetail> = {
  ...
  reel: {
    ...
    category: "Non-Technical Event",
    description:
      "Showcase your creativity in this online social media challenge. Create an original 30-second reel on the theme SIGNIFIYA 2026, post it on Instagram, and compete for cash prizes, an Instagram feature, and a collab with the official Signifiya page.",
    objective: [
      "Promote creativity and digital storytelling",
      "Encourage original content creation around the SIGNIFIYA 2026 theme",
      "Test video editing and visual appeal skills",
      "Engage audiences through Instagram and social media platforms",
    ],
    participation: {
      teamSize: "No specific team size limit",
      registrationFee: "Free",
      eligibility: "Open to all students",
    },
    format: [
      "Theme: SIGNIFIYA 2026",
      "Reel duration: 30 seconds",
      "Platform: Instagram — must tag @signifiya and @phoenix_nipashree",
      "Submission: Post the reel and submit the link before the deadline",
    ],
    judgingCriteria: [
      "Judged by the Signifiya social media team",
      "Creativity and originality",
      "Relevance to the theme (SIGNIFIYA 2026)",
    ...
    prizeStructure: {
      ...
      details: [
        "Cash Prize: ₹2,000 🎉",
        "Winner featured on the official Instagram page of Signifiya",
        "Signifiya will send a collab to the winning team — reel uploaded on Signifiya's page and Adamas University's official page",
        "Certificates for all participants",
      ],
    },
    schedule: {
    ...
    rules: [
      "Theme: The reel must be based on the theme — SIGNIFIYA 2026.",
      "Duration: The reel must be exactly 30 seconds long.",
      "Original Content: All content must be original and created by the participant/team. Plagiarism or copied content will lead to disqualification.",
      "Platform: The reel must be posted on Instagram.",
      "Hashtags & Tags: Participants must tag the official event page (@signifiya) and the event organizer (@phoenix_nipashree).",
      "Team Size: No specific team size limit.",
      "Submission Deadline: The reel must be posted and the link submitted before the given deadline.",
      "Content Guidelines: No offensive, abusive, or inappropriate content. The reel must comply with Instagram community guidelines.",
      "Judging Criteria: Reels will be judged by the Signifiya social media team based on creativity, relevance to theme, visual appeal and editing, engagement (likes, comments, shares), and overall impact.",
      "Decision of Judges: The decision of the judges will be final and binding.",
      "Disqualification: Any participant violating the rules or submitting misleading content will be disqualified.",
    ],
    additionalInfo: [
      "Faculty Coordinator: Nisarga Chand",
      "Student Coordinator: Nipashree Bhattacharya (@phoenix_nipashree)",
      "Winner will receive a collaboration request from Signifiya — the winning reel will be uploaded on both the Signifiya page and Adamas University's official Instagram page.",
    ],
  },
};
