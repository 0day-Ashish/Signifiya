...
const SPONSORS = SPONSOR_LOGO_FILES.map((file, index) => ({
  ...
  logo: `https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/logos/${file}`,
}));
      ...
      <div className="bg-white rounded-[2.5rem] p-8 sm:p-12 relative overflow-hidden flex flex-col gap-12 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <FadeIn delay={300}>
          <div className="flex flex-col gap-8 mt-12 pt-8 border-t-4 border-black">
            <h3
              className={`text-4xl sm:text-5xl text-black uppercase text-center ${gilton.className}`}
            >
            ...
            <div className="flex flex-row flex-wrap items-center justify-center gap-12 py-4">
              {/* CSI Logo */}
              <Image
                src="https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/csi.avif"
              ...
              {/* ACM Logo */}
              <Image
                src="https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/acmlogo.png"
              ...
              {/* Cerkle Logo */}
              <Image
                src="https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/cerkle.avif"
                alt="Cerkle"
                width={200}
                height={90}
                priority
