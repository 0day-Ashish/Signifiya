  ...
  return (
    <section className="w-full bg-black pt-3 flex flex-col gap-3">
      ...
      <div className="flex flex-col lg:flex-row gap-3">
        ...
        <div className="flex-1 lg:flex-[1.5] bg-[#f3e5f5] rounded-[2.5rem] sm:p-12 relative overflow-hidden flex flex-col justify-center min-h-[400px] group">
          ...
          <div className="z-10 relative">
            <FadeIn>
              <h2
                className={`text-2xl sm:text-5xl md:text-6xl text-black leading-[0.9] tracking-tight mb-6 sm:mb-8 uppercase text-left ml-4 sm:ml-0 ${gilton.className}`}
              >
            ...
            <FadeIn delay={200}>
              <p
                className={`text-black text-left text-base sm:text-xl md:text-2xl font-medium leading-relaxed max-w-lg sm:max-w-xl mx-4 sm:mx-0 ${softura.className}`}
              >
                Signifiya is not just an event; it&apos;s an experience. We
                bring together the brightest minds, the boldest creators, and
                the most passionate individuals for a celebration of innovation,
                art, and culture.
              </p>
              <div className="mt-8">
                ...
                >
                  * Students participating in any Signifiya event do not need a
                  visitor&apos;s pass.
                </p>
              </div>
            </FadeIn>
        ...
        <div className="flex-1 bg-white rounded-[2.5rem] relative overflow-hidden flex items-center justify-center min-h-[400px] border-4 border-black">
          <Image
            src="https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/about.jpg"
            alt="About Signifiya"
            fill
            priority
      ...
      <div className="flex flex-col lg:flex-row gap-3">
        ...
        <div className="flex-1 bg-white rounded-[2.5rem] relative overflow-hidden flex items-center justify-center min-h-[400px] border-4 border-black">
          <Image
            src="https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/soet-au.jpeg"
            alt="About Signifiya"
            fill
            priority
            className="object-cover"
        ...
        <div className="flex-1 lg:flex-[1.5] bg-[#E0F2FE] rounded-[2.5rem] sm:p-12 relative overflow-hidden flex flex-col justify-center min-h-[400px] group">
          ...
          <div className="absolute top-8 left-8 w-12 h-12 sm:w-16 sm:h-16 bg-[#FF6B6B] rounded-full border-2 border-black flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-12 z-20 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px]">
            <svg
              className="w-6 h-6 sm:w-8 sm:h-8 text-black transition-all duration-300 group-hover:scale-110"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
          ...
          <div className="z-10 relative flex flex-col items-end text-right">
            <FadeIn>
              <h2
                className={`text-3xl sm:text-5xl md:text-6xl text-black leading-[0.9] mr-5 sm:mr-0 sm:mt-0 tracking-tight mb-6 sm:mb-8 uppercase ${gilton.className}`}
              >
            ...
            <FadeIn delay={200}>
              <p
                className={`text-black text-right text-base sm:text-xl md:text-2xl font-medium leading-relaxed max-w-xl mr-4 sm:mr-0 ${softura.className}`}
              >
                The School of Engineering and Technology stands as a beacon of
                technical excellence, fostering innovation and shaping the
                future engineers who will build tomorrow's world.
              </p>
            </FadeIn>
          </div>
        </div>
