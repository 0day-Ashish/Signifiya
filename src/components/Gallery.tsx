...
const GALLERY_IMAGES = [
  {
    src: "https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/gallery/gallery-01.jpeg",
    alt: "Gallery Image 1",
  ...
  {
    src: "https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/gallery/gallery-15.jpeg",
    alt: "Gallery Image 2",
    span: "col-span-1 row-span-1",
    rotation: "-rotate-3",
  },
  {
    src: "https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/gallery/gallery-33.jpeg",
    alt: "Gallery Image 3",
    span: "col-span-1 row-span-1",
    rotation: "rotate-1",
  },
  {
    src: "https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/gallery/gallery-05.jpeg",
    alt: "Gallery Image 4",
    span: "col-span-1 row-span-1",
    rotation: "-rotate-2",
  },
  {
    src: "https://pub-7bb925c121d140598e02eb321a90257a.r2.dev/gallery/gallery-40.jpeg",
    alt: "Gallery Image 5",
    ...
    <section id="gallery" className="w-full bg-black pb-3">
      <div className="bg-[#fff1f2] rounded-[2.5rem] p-8 sm:p-12 relative overflow-hidden flex flex-col gap-12 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="flex justify-center mt-4">
          <Link
            href="/gallery"
            className={`bg-black text-white px-8 py-3 rounded-full border-2 border-white shadow-[6px_6px_0px_0px_rgba(0,0,0,0.2)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-[3px] hover:translate-y-[3px] transition-all uppercase font-bold text-lg tracking-wider inline-block ${softura.className}`}
          >
            View Gallery
          </Link>
        </div>
